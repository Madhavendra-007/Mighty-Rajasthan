...
<div className='dayDescription'>
    ...
    <div className="daysContainer bgImgRight bgImg1">
      ...
      <div className="dayDesc day1Desc1"></div>
      <div className="dayCard day1Card1"></div>
      </div>
    </div>
    ...
    <div className="daysContainer bgImgLeft bgImg2">
      ...
      <div className="dayDesc day1Desc2"></div>
      <div className="dayCard day1Card2"></div>
      </div>
    </div>
    <div className="daysContainer bgImgRight bgImg3">
      <div className='align'>   

      <div className="dayDesc day1Desc3"></div>
      <div className="dayCard day1Card3"></div>
      </div>
    </div>
    <div className="daysContainer bgImgLeft bgImg4">
      <div className='align'>

      <div className="dayDesc day1Desc4"></div>
      <div className="dayCard day1Card4"></div>
      </div>
    </div>
    <div className="daysContainer bgImgRight bgImg5">
      <div className='align'>

      <div className="dayDesc day1Desc5"></div>
      <div className="dayCard day1Card5"></div>
      </div>
    </div>
    <div className="daysContainer bgImgLeft bgImg6">
      <div className='align'>

      <div className="dayDesc day1Desc6"></div>
